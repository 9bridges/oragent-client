...
import net.tbsoft.oragentclient.agent.Response;
...
public class HttpClientUtils {
    ...
    public static Response<byte[]> httpRequestGetOragentFull(HttpHost httpHost, int mapId) {
        HttpGet httpRequest = new HttpGet();
        httpRequest.setURI(URI.create("/oragentfull?" + "mapno=" + mapId));
        return httpRequest(httpHost, httpRequest);
    }

    public static Response<byte[]> httpRequestGetOragentStop(HttpHost httpHost, int mapId) {
        HttpGet httpRequest = new HttpGet();
